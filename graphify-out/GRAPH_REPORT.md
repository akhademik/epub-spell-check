...
## Summary
- 508 nodes · 878 edges · 34 communities (24 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1ae27783`
...
Cohesion: 0.11
Nodes (38): CheckSettings, Dictionaries, Dictionary, DictionaryStatus, IndexedDictionary, TextContentBlock, ErrorGroup, ErrorInstance (+30 more)
...
### Community 9 - "state.svelte.ts"
Cohesion: 0.16
Nodes (9): FONT_SIZE_MIN_REM, ALL_ERROR_TYPES, appState, getInitialEnabledErrorTypes(), loadStorage(), PersistedContainer, STORAGE_KEYS, ReaderSettings (+1 more)
...
Cohesion: 0.12
Nodes (16): CONTEXT_LENGTH_CHARS, DICTIONARY_VERSION, EPUB_FILE_EXTENSION, FILE_SIZE_LIMIT_BYTES, FILE_SIZE_LIMIT_MB, FONT_SIZE_MAX_REM, MAX_PRIMARY_SUGGESTION_COUNT, MAX_SECONDARY_SUGGESTION_COUNT (+8 more)
...
Cohesion: 0.17
Nodes (7): activeClusters, handleIgnoreCluster(), handleSyncToCloudflare(), runAudit(), tierAFindings, tierBFindings, ignoreDuplicatePair()
...
## Knowledge Gaps
- **193 isolated node(s):** `Dictionary`, `AnalysisProgressCallback`, `ConfusableRule`, `WorkerMessage`, `Env` (+188 more)
...
- **What connects `Dictionary`, `AnalysisProgressCallback`, `ConfusableRule` to the rest of the system?**
