...
export const SETTINGS_FILTER_DEBOUNCE_MS = 50; // Short debounce for settings re-filter

export const EPUB_FILE_EXTENSION = ".epub";
export const WHITELIST_FILE_EXTENSIONS = ["txt", "md"];

export const CONTEXT_LENGTH_CHARS = 60; // Characters before and after target word for context view
